...
/**
 * Единая русская локализация интерфейса OPTRF.
...
(() => {
    ...
    const exact = new Map(
        Object.entries({
            ...
            'Stop all screens sharing': 'Остановить демонстрацию у всех',
            'Stop screen share to all participants': 'Остановить демонстрацию экрана у всех участников',
            'Share file to all': 'Отправить файл всем',
            'Share audio/video to all': 'Показать аудио/видео всем',
            'Eject all participants': 'Удалить всех участников',
            'Toggle audio': 'Выключить / включить микрофон',
            'Toggle video': 'Выключить / включить камеру',
            'Toggle screen': 'Остановить демонстрацию экрана',
            'Share file': 'Отправить файл',
            'Share audio/video': 'Показать аудио / видео',
            'Share Audio/Video': 'Показать аудио / видео',
            'Get geolocation': 'Запросить геолокацию',
            'Ban participant': 'Заблокировать участника',
            'Eject participant': 'Удалить из комнаты',
            'Private messages': 'Личные сообщения',
            'Private mess...': 'Личные сообщ...',
            'In progress, wait...': 'Выполняется, подождите...',
